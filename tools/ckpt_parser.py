...
def obtain_tensors_in_checkpoint_file(file_name):
    tensor_name = []
    reader = pywrap_tensorflow.NewCheckpointReader(file_name)
    var_to_shape_map = reader.get_variable_to_shape_map()
    for key in sorted(var_to_shape_map):
        tensor_name.append(key+':0')
...
if __name__ == "__main__":
  ...
  parser.add_argument(
      "--file_name", type=str, default="../model_util/pspnet/weights/pspnet101_cityscapes.ckpt", help="Checkpoint filename. "
