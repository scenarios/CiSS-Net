...
from datasets.cityscapesscripts.helpers.csHelpers import printError
from datasets.cityscapesscripts.preparation.json2labelImg import json2labelImg
...
def main():
    ...
    if 'CITYSCAPES_DATASET' in os.environ:
        ...
        cityscapesPath = 'D:/data/yizhou/cityspace'
